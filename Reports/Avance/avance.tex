...
\title			{Escribiendo informes científicos usando \LaTeX}
\author         {Nombre y Apellidos - estudiante} % La palabra estudiante la borran
\email          {usuario.institucional@ucr.ac.cr}
\author         {Nombre y Apellidos - supervisor}% La palabra supervisor la borran
\email          {usuario.institucional@ucr.ac.cr}
